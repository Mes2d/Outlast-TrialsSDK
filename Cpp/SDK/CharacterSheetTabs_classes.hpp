...
public:
	...
	class URBCharacterSheetTabMenuButton_C*       TasksButton;                                       // 0x0298(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class URBCharacterSheetTabMenuButton_C*       TrialButton_1;                                     // 0x02A0(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
...
static_assert(sizeof(UCharacterSheetTabs_C) == 0x0002A8, "Wrong size on UCharacterSheetTabs_C");
...
static_assert(offsetof(UCharacterSheetTabs_C, TasksButton) == 0x000298, "Member 'UCharacterSheetTabs_C::TasksButton' has a wrong offset!");
static_assert(offsetof(UCharacterSheetTabs_C, TrialButton_1) == 0x0002A0, "Member 'UCharacterSheetTabs_C::TrialButton_1' has a wrong offset!");
